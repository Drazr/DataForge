...
Available: the user's original pasted Cells 6/7, their SHA-256 hashes, and a
derived summary containing only displayed values. They are not substitutes for
the complete 294 observations, confidence intervals or raw audio.
