...
3. [Noise Grid v2](https://github.com/Drazr/DataForge/tree/noise-grid-v2) — `colab_noise_masking.py` for CPU INT8 measurement, then `colab_grid_analysis.py` for CPU analysis.
...
tested CPU implementation is on `noise-grid-v2` at commit `698fb0e`.
